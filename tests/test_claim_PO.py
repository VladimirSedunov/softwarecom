...
list_claim = [
    Claim('Позитивный сценарий', 'Тут Пишем ФИО', 'this_is@email.mail', 'Это_телефон', 'Это сообщение', True, False, '!!! ERROR !!!   Ваш запрос отправлен менеджеру!'),
    Claim('Нет ФИО', '', 'this_is@email.mail', 'Это_телефон', 'Это сообщение', True, True, '!!! ERROR !!!   Укажите Ваше Ф.И.О!'),
    Claim('Нет телефона', 'Тут Пишем ФИО', 'this_is@email.mail', '', 'Это сообщение', False, True, '!!! ERROR !!!   Укажите Ваш контактный телефон!'),
    Claim('Нет email', 'Тут Пишем ФИО', '', 'Это_телефон', 'Это сообщение', True, True, '!!! ERROR !!!   Укажите правильный e-mail!'),
    Claim('Нет сообщения', 'Тут Пишем ФИО', 'this_is@email.mail', 'Это_телефон', '', False, True, '!!! ERROR !!!   Введите Ваше сообщение!'),
]
