...
testdata = [
    ('Позитивный сценарий', 'Тут Пишем ФИО', 'this_is@email.mail', 'Это_телефон', 'Это сообщение', True, False,
     '!!! ERROR !!! намеренные ошибки Спасибо! Ваш запрос принят, в ближайшее время мы с вами обязательно свяжемся.'),

    ('Нет ФИО', '', 'this_is@email.mail', 'Это_телефон', 'Это сообщение', True, True, 'Укажите Ваше Ф.И.О!'),
    ('Нет email', 'Тут Пишем ФИО', '', 'Это_телефон', 'Это сообщение', False, True, '!!! ERROR !!! намеренные ошибки Укажите правильный e-mail!'),
    ('Нет телефона', 'Тут Пишем ФИО', 'this_is@email.mail', '', 'Это сообщение', True, True, 'Укажите Ваш контактный телефон!'),
    ('Нет сообщения', 'Тут Пишем ФИО', 'this_is@email.mail', 'Это_телефон', '', False, True, '!!! ERROR !!! намеренные ошибки Введите Ваше сообщение!')
]
