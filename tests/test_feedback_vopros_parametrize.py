...
testdata = [
    ...
    ('Нет ФИО', '', 'this_is@email.mail', 'Это_телефон', 'Это сообщение', True, False, 'Укажите Ваше Ф.И.О!'),
    ('Нет email', 'Тут Пишем ФИО', '', 'Это_телефон', 'Это сообщение', False, False, 'Укажите правильный e-mail!'),
    ('Нет телефона', 'Тут Пишем ФИО', 'this_is@email.mail', '', 'Это сообщение', True, False, 'Укажите Ваш контактный телефон!'),
    ('Нет сообщения', 'Тут Пишем ФИО', 'this_is@email.mail', 'Это_телефон', '', False, False, 'Введите Ваше сообщение!')
]
