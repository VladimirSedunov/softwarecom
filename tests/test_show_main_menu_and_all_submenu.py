...
def test_show_main_menu_and_all_submenu(setup_browser):
    ...
    with allure.step("ТС2.3. Пройти по избранным пунктам подменю"):
        ...
        with allure.step("Открыть страницу 'Компания'"):
            hover_wait_and_click_element(browser, menu, f'{elem_name} > [href="/about/"]')
            assert browser.element('.controls-page-box .h1').should(have.exact_text('Компания'))

        with allure.step("Открыть страницу 'Отзывы'"):
            hover_wait_and_click_element(browser, menu, f'{elem_name} > [href="/about/opinions/"]')
        ...
        with allure.step("Открыть страницу 'Политика конфиденциальности'"):
            hover_wait_and_click_element(browser, menu, f'{elem_name} > [href="/about/politika-konfidentsialnosti/"]')
        ...
        with allure.step("Открыть страницу 'Разработка ПО и автоматизация процессов'"):
            hover_wait_and_click_element_and_subelement(browser, menu, f'{elem_name} [href="/solutions/razrabotka-po/"]',
        ...
        with allure.step("Открыть страницу 'Управление технологическими процессами (УТП)''"):
            hover_wait_and_click_element_and_subelement(browser, menu, f'{elem_name} [href="/solutions/produkty-i-korobochnye-resheniya/"]',
        ...
        with allure.step("Открыть страницу 'Государственный сектор'"):
            hover_wait_and_click_element(browser, menu, f'{elem_name} > [href="/branch/gosudarstvennyy-sektor/"]')
        ...
        with allure.step("Открыть страницу 'Транспорт и логистика'"):
            hover_wait_and_click_element(browser, menu, f'{elem_name} > [href="/branch/transport-i-logistika/"]')
...
def go_throw_main_menu(browser):
...
def leaf_over_bottom_blocks(browser):
